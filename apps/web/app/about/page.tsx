...
export const metadata: Metadata = {
  title: 'About',
  description:
    'How Studio Pro sources its data, what is hand-curated, what comes from TMDb, and how to read the technical metadata.',
};
...
export default function AboutPage() {
  return (
    <article className="prose-zinc max-w-2xl">
      ...
      <h1 className="mt-1 font-serif text-4xl text-zinc-50">Studio Pro</h1>
      <p className="mt-4 text-zinc-300">
        Studio Pro is a technical reference for working film professionals — DPs, gaffers,
      ...
      <ul className="mt-3 space-y-3 text-zinc-300">
        <li>
          ...
          format breakdowns. These are the productions where Studio Pro adds value
      ...
      <p className="mt-3 text-zinc-300">
        Studio Pro is built incrementally as a series of focused sub-projects: the data
