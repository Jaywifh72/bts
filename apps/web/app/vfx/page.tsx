  ...
  return (
    <>
      ...
      <nav aria-label="VFX sub-disciplines" className="mb-6 flex flex-wrap gap-2 text-sm">
        ...
        <Link href="/vfx/shot-breakdowns" className="rounded border border-zinc-700 bg-zinc-900/40 px-2.5 py-1 text-zinc-300 hover:border-amber-700 hover:text-amber-400">Shot breakdowns</Link>
