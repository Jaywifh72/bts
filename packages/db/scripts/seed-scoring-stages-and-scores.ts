...
const SCORES: ScoreSeed[] = [
  ...
  // ── Phase 3 — canonical classic scores (1958-2003) ────────────────
  // The reference shelf that working composers actually study.
  // INSERT...SELECT guard means rows no-op when productions/people
  // aren't in the DB yet — re-run as the curated tier expands.

  // John Williams
  {
    production_slug: 'star-wars-1977',
    composer_slug: 'john-williams',
    scoring_stage_slug: null,
    recording_orchestra: 'London Symphony Orchestra',
    recording_location: 'Anvil Studios, Denham',
    themes_summary: 'Wagnerian leitmotif — every major character has a theme that recurs transformed across the trilogy. Main title brass-anchored fanfare. Lucas\'s temp tracks were Holst and Korngold; Williams replaced them with original cues that hit the same registers.',
    summary: 'Single most-cited modern film score. Established the orchestral revival template that defined Hollywood scoring for 40 years.',
    cue_count_estimate: 16,
    release_label: '20th Century Fox Records',
  },
  {
    production_slug: 'the-empire-strikes-back-1980',
    composer_slug: 'john-williams',
    scoring_stage_slug: null,
    recording_orchestra: 'London Symphony Orchestra',
    recording_location: 'Anvil Studios, Denham',
    themes_summary: 'Introduces the Imperial March + Yoda\'s theme — both became canonical. More chromatic and dissonant than Star Wars (1977), reflecting the darker narrative arc.',
    summary: 'Widely cited as Williams\'s most accomplished Star Wars score. Imperial March is among the most-recognized cues in film history.',
    cue_count_estimate: 22,
    release_label: 'RSO Records',
  },
  {
    production_slug: 'raiders-of-the-lost-ark-1981',
    composer_slug: 'john-williams',
    scoring_stage_slug: null,
    recording_orchestra: 'London Symphony Orchestra',
    recording_location: 'Anvil Studios, Denham',
    themes_summary: 'Raiders March — brass-led adventure theme that became the franchise identity. Marion\'s theme as romantic counterweight; Ark/Belloq motifs as ominous mystery.',
    summary: 'First Spielberg-Williams collaboration after Jaws + Close Encounters. Established the adventure-score template.',
    cue_count_estimate: 18,
    release_label: 'Columbia Records',
  },
  {
    production_slug: 'jurassic-park-1993',
    composer_slug: 'john-williams',
    scoring_stage_slug: 'sony-scoring-stage',
    recording_orchestra: 'Hollywood Studio Symphony',
    recording_location: 'Sony Pictures Scoring Stage (then Columbia)',
    themes_summary: 'Two themes — the main "Journey to the Island" awestruck fanfare, and the secondary "Theme from Jurassic Park" hymn-like cue (the helicopter reveal). Both written before completed VFX, scored to storyboards.',
    summary: 'Cited as one of the most-imitated wonder-of-discovery cues of the 1990s.',
    cue_count_estimate: 18,
    release_label: 'MCA Records',
  },
  {
    production_slug: 'schindlers-list-1993',
    composer_slug: 'john-williams',
    scoring_stage_slug: 'air-lyndhurst-hall',
    recording_orchestra: 'Boston Symphony + Itzhak Perlman (solo violin)',
    recording_location: 'Various; violin sessions at Symphony Hall Boston',
    themes_summary: 'Solo violin (Perlman) over chamber strings — restraint over emotion. Williams originally tried to decline the assignment, citing the subject\'s gravity; Spielberg insisted.',
    summary: 'Academy Award winner for Best Original Score (1994). Williams\'s most-cited "small" score — chamber-scale rather than tentpole.',
    cue_count_estimate: 14,
    release_label: 'MCA Records',
  },
  {
    production_slug: 'saving-private-ryan-1998',
    composer_slug: 'john-williams',
    scoring_stage_slug: null,
    recording_orchestra: 'Boston Symphony + Tanglewood Festival Chorus',
    recording_location: 'Symphony Hall Boston',
    themes_summary: 'Restrained throughout — Williams deliberately stayed out of the opening Omaha Beach sequence (Spielberg wanted only ambient sound). "Hymn to the Fallen" closes the film.',
    summary: 'Notable for what Williams DIDN\'T score — the most-cited example of a composer choosing silence over cue.',
    cue_count_estimate: 14,
    release_label: 'DreamWorks Records',
  },

  // Ennio Morricone
  {
    production_slug: 'the-good-the-bad-and-the-ugly-1966',
    composer_slug: 'ennio-morricone',
    scoring_stage_slug: null,
    recording_orchestra: 'Rome session musicians',
    recording_location: 'RCA Italiana Studios, Rome',
    themes_summary: 'Coyote howl, ocarina, electric guitar, whistle. Each of the three characters gets a sonic instrument signature; main theme is the coyote-call motif.',
    summary: 'Among the most-recognized film themes ever recorded. Defined the spaghetti-western sonic palette.',
    cue_count_estimate: 17,
    release_label: 'United Artists Records',
  },
  {
    production_slug: 'the-mission-1986',
    composer_slug: 'ennio-morricone',
    scoring_stage_slug: null,
    recording_orchestra: 'Various — choir + indigenous instruments + chamber',
    recording_location: 'Multiple',
    themes_summary: 'Three braided themes: oboe (Gabriel\'s Oboe), choir (On Earth As It Is in Heaven), indigenous percussion. Morricone famously called this his favorite of his own scores.',
    summary: 'Academy nomination loss to Round Midnight became one of the most-cited Oscar misses.',
    cue_count_estimate: 17,
    release_label: 'Virgin Records',
  },
  {
    production_slug: 'the-hateful-eight-2015',
    composer_slug: 'ennio-morricone',
    scoring_stage_slug: null,
    recording_orchestra: 'Various session ensemble',
    recording_location: 'Forum Music Village, Rome',
    themes_summary: 'Reuses unused Morricone material from John Carpenter\'s The Thing (1982) — Tarantino licensed those cues + commissioned new ones. Heavy strings + low brass; minor key throughout.',
    summary: 'Academy Award winner for Best Original Score (2016). Morricone\'s only competitive Oscar win.',
    cue_count_estimate: 12,
    release_label: 'Decca Records',
  },
  ...
  // Jerry Goldsmith
  {
    production_slug: 'alien-1979',
    composer_slug: 'jerry-goldsmith',
    scoring_stage_slug: null,
    recording_orchestra: 'National Philharmonic Orchestra',
    recording_location: 'Anvil Studios, Denham',
    themes_summary: 'Cellos divisi + serpent (Renaissance brass) for the alien — Goldsmith wanted a sound no one would recognize. Director Ridley Scott replaced several cues with temp music (Howard Hanson Symphony 2) against Goldsmith\'s wishes — a famous example of the temp-track problem.',
    summary: 'Defined the modern sci-fi horror score. The director-vs-composer dispute is one of the most-cited cautionary tales in the craft.',
    cue_count_estimate: 16,
    release_label: 'Silva Screen Records',
  },
  {
    production_slug: 'chinatown-1974',
    composer_slug: 'jerry-goldsmith',
    scoring_stage_slug: null,
    recording_orchestra: 'Chamber jazz ensemble + trumpet solo',
    recording_location: 'Los Angeles',
    themes_summary: 'Solo trumpet (Uan Rasey) over jazz strings — written in TEN DAYS after Polanski rejected Phillip Lambro\'s original score. Theme became the noir-film template.',
    summary: 'Academy Award nominee. The 10-day-replacement turnaround is the stuff of scoring legend.',
    cue_count_estimate: 10,
    release_label: 'ABC Records',
  },

  // Bernard Herrmann
  {
    production_slug: 'vertigo-1958',
    composer_slug: 'bernard-herrmann',
    scoring_stage_slug: null,
    recording_orchestra: 'London Symphony Orchestra (because of US musicians strike)',
    recording_location: 'London',
    themes_summary: 'Harp arpeggios + dissonant orchestral chords — the "Vertigo prelude" became a sonic dictionary entry for psychological-thriller scoring. Madeleine\'s theme (love theme) deliberately unresolved.',
    summary: 'Recorded in London during a 1958 US musicians strike. Among the most-imitated thriller scores of all time.',
    cue_count_estimate: 18,
    release_label: 'Mercury Records',
  },
  {
    production_slug: 'psycho-1960',
    composer_slug: 'bernard-herrmann',
    scoring_stage_slug: null,
    recording_orchestra: 'String orchestra only (no winds, no brass, no percussion)',
    recording_location: 'Los Angeles',
    themes_summary: 'Strings only — Hitchcock originally wanted the shower scene unscored; Herrmann scored it anyway with the famous shrieking violins. Hitchcock changed his mind.',
    summary: 'The shower-scene cue is the most-cited single moment in film scoring history. String-only orchestration influenced decades of horror scoring.',
    cue_count_estimate: 14,
    release_label: 'Varese Sarabande',
  },
  {
    production_slug: 'taxi-driver-1976',
    composer_slug: 'bernard-herrmann',
    scoring_stage_slug: null,
    recording_orchestra: 'Jazz + symphonic ensemble',
    recording_location: 'Los Angeles',
    themes_summary: 'Saxophone-led noir theme over harp + brass. Herrmann\'s final score — he died the night recording wrapped, December 24, 1975. Film dedicated to him.',
    summary: 'Herrmann\'s final score; he died hours after the last session. Considered among his finest.',
    cue_count_estimate: 12,
    release_label: 'Arista Records',
  },

  // Howard Shore — LOTR trilogy
  {
    production_slug: 'the-lord-of-the-rings-the-fellowship-of-the-ring-2001',
    composer_slug: 'howard-shore',
    scoring_stage_slug: 'abbey-road-studio-one',
    recording_orchestra: 'London Philharmonic + London Voices + boy soprano soloists',
    recording_location: 'Abbey Road Studio One + Wellington sessions',
    themes_summary: 'Wagnerian leitmotif — every major culture (Hobbits, Rohan, Gondor, Mordor, Elves, Dwarves) has its own thematic family. Boy soprano (Edward Ross) for Hobbit-realm cues.',
    summary: 'Academy Award winner for Best Original Score (2002). The most-ambitious orchestral-leitmotif construction in modern film scoring.',
    cue_count_estimate: 26,
    release_label: 'Reprise Records',
  },
];
