...
export const productionColorPipelines = pgTable('production_color_pipelines', {
  ...
  hdrPeakNits: integer('hdr_peak_nits'),
  dolbyVisionProfile: text('dolby_vision_profile'),
  masteringDisplayNits: integer('mastering_display_nits'),
  ambientLightNits: integer('ambient_light_nits'),
  colorChart: text('color_chart'),
  showLutFilename: text('show_lut_filename'),
  showLutUrl: text('show_lut_url'),
